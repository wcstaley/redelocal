<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OrderCompleted.aspx.cs" Inherits="RedE.Web.Root.RedE.Email.OrderCompleted" %>
												...
												<tr>
													...
													<td align="right" style="text-align:right; margin:0; padding:0; width:50%; border-collapse:collapse; border-spacing:0;">
															<table style="height: 40px; background-color: #2491d7 transparent;" width="200" cellspacing="0" cellpadding="0" align="right">
																<tbody>
																	<tr>
																		<td style="border-radius: 3px; text-align: center; background-color: #B62B27; color: #ffffff; font-size: 14px; line-height: 20px;"><a style="text-decoration: none; color: #ffffff;font-family: Arial, Helvetica, sans-serif; " href="http://rede-marketing.com/login">Review Order</a></td>
																	</tr>
																</tbody>
															</table>
													</td>
											...
											<tr>
												<td style="padding: 10px 20px 30px;">
													<p style="padding: 0 0 5px; font-family: Arial, Helvetica, Sans-serif; line-height:14px; font-size:14px;color: #666666;text-align:center;">
                                                        <strong>APPROVED - ORDER COMPLETED</strong>
													</p>
													<p style="padding: 0 0 5px; font-family: Arial, Helvetica, Sans-serif;text-align:left;line-height:22px; font-size:14px;color: #666666;">
														Greetings,<br/><br/>
														Proof for order <strong><%= order_id %></strong> has been approved. This marks your order as COMPLETED. Thank you for using Red/E.
													</p>
												</td>
											</tr>
										</table>
